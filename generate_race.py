...
def create_race_svg(username="Moty2111"):
    ...
    dwg.add(dwg.text("🏎️ RACE PROGRESS", insert=(400,35), fill="#FFD700", font_size="24", font_weight="bold", text_anchor="middle", font_family="monospace"))
    ...
    if bar_w>0:
        ...
        dwg.add(dwg.text("🏎️", insert=(50+bar_w,62), font_size="26", text_anchor="middle"))
        # процент крупнее
        dwg.add(dwg.text(f"{progress}%", insert=(50+bar_w,50), fill="#FFD700", font_size="18", text_anchor="middle", font_weight="bold"))
    # Статистика крупнее
    stats = f"Commits: {commits}   |   Repos: {repos}   |   Followers: {followers}"
    dwg.add(dwg.text(stats, insert=(400,130), fill="#FFFFFF", font_size="18", text_anchor="middle"))
    dwg.add(dwg.text("🏁", insert=(50,160), font_size="30", text_anchor="middle"))
    dwg.add(dwg.text("🏁", insert=(750,160), font_size="30", text_anchor="middle"))
    dwg.add(dwg.text("UPDATED EVERY 8 HOURS", insert=(400,200), fill="#6C7A89", font_size="11", text_anchor="middle", font_style="italic"))
    dwg.save()
